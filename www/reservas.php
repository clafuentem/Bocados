					...
					<div class="login-box">
						<form method="post" action="do_login.php">
							<div class="login">
								...
								<input type="hidden" name="url" value="reservas.php">
							</div>
					...
					<form method="post" action="do_reservas.php">
						...
						if (!empty($user_id)) {
							...
							echo '<h2 href="" style="color: white ;">Para poder hacer una reserva deberás estar registrado.</h2>
                      		<h3 style="color: white ;"><a style="color: brown;" href="register.php">Registrate aquí!</a></h3>';
						}
						...
						<div class="reservas-form hide">
							...
							if ($result->num_rows > 0) {
								while ($row = $result->fetch_assoc()) {
									...
									<input type="text" name="surname" placeholder="Apellidos" value="' . $row['surname'] . '"><br><br>
									<input type="text" name="telf" placeholder="Nº Teléfono" value="' . $row['telf'] . '" required><br><br>
									<label for="" class="label-options">Personas</label><br><br>
									<select name="pax">
                      ...
                      WHERE tHorario.reservado != 1';
							...
							if ($result->num_rows > 0) {
								...
								echo '<label for="" class="label-options">Hora</label><br><br>';
